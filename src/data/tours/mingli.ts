...
const NEED_PROFILE =
  "（如果右侧看不到四柱，请先在「卷一 · 问者档」填生辰建档——这一课用你自己的盘当教材。）";
    ...
    steps: () => [
      {
        popover: {
          title: "命理径 · 第一课 认盘",
          description: `先认清三件事：\n\n· 盘上哪个字是「你」\n· 字的颜色是什么意思\n· 四柱怎么读成一条时间轴\n\n跟着看一遍，你就知道这张盘在说什么。${NEED_PROFILE}`,
        },
      },
      {
        ...
        popover: {
          title: "看这里 · 四柱",
          description:
            "盘面分四列，每列两个字——上是天干（甲乙丙丁…），下是地支（子丑寅卯…）。\n\n这八个字 = 你出生那一刻的「气」的快照。由历法查表得出，模型不参与推算。",
          side: "left",
        },
      },
      {
        ...
        popover: {
          title: "看这里 · 五行颜色",
          description:
            "每个字的颜色 = 它的五行：\n木绿 · 火朱 · 土赭 · 金褐 · 水黛\n\n扫一眼颜色分布，就能看出哪种气多、哪种气缺——不用数，看色就行。",
          side: "left",
        },
      },
      {
        ...
        popover: {
          title: "看这里 · 日主 =「你」",
          description:
            "日柱的天干（朱色底标注）就是日主——全盘的「你」。\n\n其余七个字都相对日主论关系，这套关系名就叫「十神」（下一课讲）。先记住：日主是坐标原点。",
          side: "left",
        },
      },
      {
      ...
      },
      {
        popover: {
          title: "试一试",
          description:
            "退出导览后，点一下你的日柱（朱色那格）——会弹出释义卡，讲这一柱的宫位含义、干支关系与藏干。\n\n盘面任何字都可以点——这就是「把排盘做成教材」的方式。",
        },
      },
    ],
  },
