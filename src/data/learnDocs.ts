...
export const LEARN_DOCS: LearnDoc[] = [
  ...
  {
    slug: "ai-product-scenarios",
    file: "docs/ai-product-scenarios.md",
    title: "AI 产品与业务场景",
    blurb: "什么问题值得用 AI？ROI 怎么算？怎么试点？什么时候要人工兜底",
    track: "agent",
    order: 12,
    stage: "一 · 认地图",
    level: "入门",
  ...
  },
  {
    ...
    title: "API 与系统集成",
    blurb: "HTTP/REST/JSON/鉴权/Webhook/MCP/插件——把 AI 接进产品，不停在网页 Demo",
    track: "agent",
    order: 48,
    stage: "二 · 拆系统",
    level: "进阶",
  ...
  },
  {
    ...
    title: "生产部署与运维",
    blurb: "环境变量/Docker/云部署/监控/告警/灰度/回滚/成本治理——从本地到上线",
    track: "agent",
    order: 140,
    stage: "八 · 上线与治理",
    level: "工程",
  },
  {
    ...
    file: "docs/ai-security-governance.md",
    title: "AI 安全与治理",
    blurb: "数据分级/PII 脱敏/权限/审计/提示注入防护/内容安全/人工复核",
    track: "agent",
    order: 150,
    stage: "八 · 上线与治理",
    level: "工程",
  ...
  },
  {
    ...
    title: "Python 基础（附录）",
    blurb: "变量 / 列表 / 字典 / 循环 / 函数 / 文件读写 / Git / 调试——给从没写过 Python 的人",
    track: "agent",
    order: 210,
    stage: "附录 · 基础知识",
    level: "入门",
  },
  {
    ...
    file: "docs/model-training-infra.md",
    title: "模型训练与 AI 基础设施（附录）",
    blurb: "Transformer/微调/LoRA/GPU/MLOps/推理服务——从用模型到懂模型",
    track: "agent",
    order: 220,
    stage: "附录 · 基础知识",
    level: "进阶",
